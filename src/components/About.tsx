  ...
  export default function About() {
    ...
    <p className="text-gray-600 leading-relaxed mb-5 text-base sm:text-lg">
      Seit über 130 Jahren ist Stall Ibs ein Ort, an dem Pferde und
    ...
    <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
      ...
      ein Pferdehof, sondern eine Gemeinschaft von Pferdeliebhabern,
      die sich gegenseitig unterstützen. Ob Freizeitreiter, Familie oder
